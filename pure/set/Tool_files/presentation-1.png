<!DOCTYPE html>
<!-- saved from url=(0027)http://localhost/Airinei/ -->
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        
        <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
        <title>GrandSocial - Social Marketing Tool</title>
        ...
        <link rel="icon" type="image/png" href="http://localhost/Airinei/favicon.png">
        <link rel="stylesheet" href="https://grandsocial.org/pure/set/Tool_files/Tool_files/flag-icon.css">
        <link rel="stylesheet" href="https://grandsocial.org/pure/set/Tool_files/Tool_files/all.css">
        <link rel="stylesheet" href="https://grandsocial.org/pure/set/Tool_files/Tool_files/style.css" id="stylesheet">
    ...
    <body class="g-sidenav-show g-sidenav-pinned" data-new-gr-c-s-check-loaded="14.1120.0" data-gr-ext-installed="" cz-shortcut-listen="true">
            ...
            <nav class="navbar navbar-main navbar-expand-lg navbar-transparent navbar-dark bg-dark" id="navbar-main">
                <div class="container px-lg-0">
                    ...
                    <a class="navbar-brand mr-lg-5" href="../../../index.html">
                        <img alt="Logo" class="h-70" src="https://grandsocial.org/pure/set/Tool_files/Tool_files/mgsocialWhite.png" id="navbar-logo">
                    </a>
                    ...
                    <div class="collapse navbar-collapse" id="navbar-main-collapse">
                        ...
                        <ul class="navbar-nav align-items-lg-center ml-lg-auto">
                            <li class="nav-item d-lg-none d-xl-block language-box">
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-fit dropdown-menu-anim dropdown-menu-top-unround">
                                        <a class="dropdown-item actionItem" href="../6b2da9e08f4af13383d1556609b0b53c" data-redirect=""><i class="flag-icon flag-icon-us"></i> English</a>
                                    </div>
                                </div>
                            </li>
                            ...
                            <li class="nav-item mr-0">
                                <a href="../../../signup.php" class="nav-link d-lg-none">Sign Up</a>

                                <a href="../../../signup.php" class="btn btn-sm btn-white rounded-pill btn-icon rounded-pill d-none d-lg-inline-flex">
        ...
        <div class="main-content">
            <!-- Header (v1) -->
            <section class="header-1 section-rotate bg-section-secondary" data-offset-top="#header-main" style="padding-top: 103.188px;">
                            ...
                            <div class="col-lg-5 col-xl-6 text-center text-lg-left">
                                <div>
                                    <h2 class="text-white mb-4">
                                        <span class="fs-40 fw-7">#1 Marketing Platform for Social Network</span>

                                        <span class="d-block">All in one <strong class="font-weight-light">brand building tools</strong></span>
                                    </h2>

                                    <p class="lead text-white">With our service will help you save time and optimize profile management on social networks. Visually Plan, Schedule post and automation on social networks.</p>

                                    <div class="mt-4">
                                        <a href="http://localhost/Airinei/signup" class="btn btn-white rounded-pill hover-translate-y-n3 btn-icon mr-sm-3 scroll-me p-l-30 p-r-30 p-t-15 p-b-15">
                                            <span class="btn-inner--text">Try it now</span>

                                            <span class="btn-inner--icon"><i class="far fa-angle-right"></i></span>
                                        </a>

                                        <a href="http://localhost/Airinei/#features" class="btn btn-outline-white rounded-pill hover-translate-y-n3 btn-icon d-none d-xl-inline-block scroll-me p-l-30 p-r-30 p-t-15 p-b-15">
  ...
  <g fill="none" fill-rule="evenodd" transform="translate(2 3)">
    ...
    <mask id="download-d" fill="#fff">
      <use xlink:href="#download-c"></use>
    </mask>
    <use fill="#000" fill-rule="nonzero" xlink:href="#download-c"></use>
    <g fill="#7600FF" mask="url(#download-d)">
      <rect width="24" height="24" transform="translate(-2 -3)"></rect>
                                ...
                                <div class="px-4 pb-5">
                                    <h5 class="fs-16">No downloads</h5>

                                    <p class="text-muted fw-3">You can use our service straight from the web on all browsers. You don't need to download or install anything to enjoy our service</p>
                                </div>
                            </div>
                        </div>
  ...
  <g fill="none" fill-rule="evenodd" transform="translate(2 1)">
    ...
    <g fill="#7600FF" mask="url(#shield-d)">
      <rect width="24" height="24" transform="translate(-2 -1)"></rect>
                                ...
                                <div class="px-4 pb-5">
                                    <h5 class="fs-16">Saving Time</h5>

                                    <p class="text-muted fw-3">Dedicating just 10-20 minutes a day on your social media strategy can dramatically improve your customer relations and interactions</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="card text-center hover-shadow-lg hover-translate-y-n10">
                                <div class="px-4 py-5">
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24" height="24" viewBox="0 0 24 24" class="injected-svg svg-inject" style="height: 70px;">
  <defs>
    <path id="calendar-a" d="M0,0 L18,0 L18,2 L0,2 L0,0 Z M0,11 L18,11 L18,13 L0,13 L0,11 Z"></path>
  ...
  <g fill="none" fill-rule="evenodd" transform="translate(2 2)">
    <g transform="translate(1 6)">
      <mask id="calendar-b" fill="#fff">
        <use xlink:href="#calendar-a"></use>
      </mask>
      <use fill="#D8D8D8" xlink:href="#calendar-a"></use>
      <g fill="#FFA0A0" mask="url(#calendar-b)">
        <rect width="24" height="24" transform="translate(-3 -8)"></rect>
      </g>
    </g>
    <mask id="calendar-d" fill="#fff">
      <use xlink:href="#calendar-c"></use>
    </mask>
    <use fill="#000" fill-rule="nonzero" xlink:href="#calendar-c"></use>
    <g fill="#7600FF" mask="url(#calendar-d)">
      <rect width="24" height="24" transform="translate(-2 -2)"></rect>
                                ...
                                <div class="px-4 pb-5">
                                    <h5 class="fs-16">Schedule posts</h5>

                                    <p class="text-muted fw-3">Select your date, time or whenever you want to publish on each your social accounts just need a few click to complete and enjoy</p>
                                </div>
                            </div>
                        </div>
  ...
  <g fill="none" fill-rule="evenodd" transform="translate(1 2)">
    ...
    <g fill="#7600FF" mask="url(#bar-d)">
      <rect width="24" height="24" transform="translate(-1 -2)"></rect>
                                ...
                                <div class="px-4 pb-5">
                                    <h5 class="fs-16">Analytics performance</h5>

                                    <p class="text-muted fw-3">You can see all your posts how it work and increase does. It will help you control your audiences and target</p>
                                </div>
                            </div>
                        </div>
  ...
  <g fill="none" fill-rule="evenodd" transform="translate(3 1)">
    ...
    <mask id="user-d" fill="#fff">
      <use xlink:href="#user-c"></use>
    </mask>
    <use fill="#000" fill-rule="nonzero" xlink:href="#user-c"></use>
    <g fill="#7600FF" mask="url(#user-d)">
      <rect width="24" height="24" transform="translate(-3 -1)"></rect>
                                ...
                                <div class="px-4 pb-5">
                                    <h5 class="fs-16">Influencer Marketing</h5>

                                    <p class="text-muted fw-3">Focus on your top influencers &amp; supporters so you don't miss their engagements follow them</p>
                                </div>
                            </div>
                        </div>
  ...
  <g fill="none" fill-rule="evenodd" transform="translate(2 1)">
    ...
    <g fill="#7600FF" mask="url(#shield-d)">
      <rect width="24" height="24" transform="translate(-2 -1)"></rect>
                                ...
                                <div class="px-4 pb-5">
                                    <h5 class="fs-16">Safe and Secure</h5>

                                    <p class="text-muted fw-3">Your data is safe with us. We're not one of those companies that gives your personal information away</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="container">
                    <div class="row row-grid justify-content-around align-items-center">
                        <div class="col-lg-5 order-lg-2">
                            <div class="pr-lg-4">
                                <h5 class="h3">Streamline your social media processes &amp; delivery for your clients</h5>

                                <p class="lead mt-4 mb-5">
                                    Whether focusing on a campaign for one brand or managing social across hundreds, Our service helps agency teams be more productive by managing all their client activities from a centralized hub. Our
                        ...
                        <div class="col-lg-6 order-lg-1">
                            <img alt="" src="https://grandsocial.org/pure/set/Tool_files/Tool_files/presentation-1.png" class="img-fluid img-center">
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section class="slice slice-lg">
                <div class="container">
                    <div class="row row-grid justify-content-around align-items-center">
                        <div class="col-lg-5">
                            <div class="">
                                <h5 class="h3">A complete solution for your social marketing &amp; save your time</h5>

                                <p class="lead my-4">With an intuitive interface and a lot of extra features to help you create articles that are interesting and easier</p>
                                ...
                                <ul class="list-unstyled">
                                    <li class="py-2">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                <span class="h6 mb-0">Perfect for modern use</span>
                                            </div>
                                        </div>
                                    </li>
                                    ...
                                    <li class="py-2">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                <span class="h6 mb-0">Image editing, easy uploading and watermark support</span>
                                            </div>
                                        </div>
                                    </li>
                                    ...
                                    <li class="py-2">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                <span class="h6 mb-0">Quality design and visualization</span>
                                            </div>
                                        </div>
                                    </li>
                                </ul>
                        ...
                        <div class="col-lg-6">
                            <img alt="" src="https://grandsocial.org/pure/set/Tool_files/Tool_files/presentation-2.png" class="img-fluid img-center">
                        </div>
                    </div>
                </div>
            </section>
    ...
    <path class="fill-purple" d="M 929.895 57.225 C 930.389 55.951 931.524 55.036 932.875 54.826 L 945.523 52.862 C 946.873 52.652 948.232 53.179 949.089 54.243 L 957.115 64.213 C 957.972 65.278 958.196 66.719 957.702 67.993 L 953.08 79.928 C 952.587 81.203 951.45 82.117 950.1 82.328 L 937.453 84.293 C 936.103 84.502 934.742 83.976 933.886 82.911 L 925.86 72.941 C 925.004 71.876 924.78 70.435 925.273 69.16 L 929.895 57.225 Z"></path>
                ...
                <div class="container position-relative zindex-100">
                    <div class="mb-5 px-3 text-center">
                        <span class="badge badge-soft-success badge-pill badge-lg"> Inspect Accounts </span>

                        <h3 class="mt-4">What we Offer</h3>

                        <div class="fluid-paragraph mt-3">
                            <p class="lead lh-180">We're more than a scheduling tool. Explore our features, and beat the algorithm.</p>
                        </div>
                    </div>
                                ...
                                <div class="card-body py-5">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="icon-text pl-4">
                                            <h5 class="mb-0">Visually plan and schedule your social media campaigns</h5>
                                        </div>
                                    </div>

                                    <p class="mt-4 mb-0">Coordinate creative campaigns to drive engagement on social</p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card px-3">
                                <div class="card-body py-5">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="icon-text pl-4">
                                            <h5 class="mb-0">Measure and report on the performance of your content</h5>
                                        </div>
                                    </div>

                                    <p class="mt-4 mb-0">Get in-depth insights to grow your reach, engagement, and sales</p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card px-3">
                                <div class="card-body py-5">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="icon-text pl-4">
                                            <h5 class="mb-0">Monitor engagement across all your social channels</h5>
                                        </div>
                                    </div>

                                    <p class="mt-4 mb-0">Engage with your audience &amp; build a community that loves your brand.</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <section class="slice slice-xl has-floating-items bg-gradient-primary" id="sct-call-to-action">
                <a href="http://localhost/Airinei/#sct-call-to-action" class="tongue tongue-up tongue-section-secondary" data-scroll-to="">
                ...
                <div class="container text-center">
                    <div class="row">
                        <div class="col-12">
                            <h1 class="text-white m-b-40">Brand Success drives business success</h1>

                            <div class="row justify-content-center mt-4">
                                <div class="col-lg-8">
                                    <p class="lead text-white">
                                        When competition for attention is fierce, and every customer is an influencer, growing an inspiring brand is a key success factor for your organization. From SMEs to large corporations, agencies and
                                        non-profits, teams of all sizes need to embrace the processes, workflows and tools that foster Brand Success. <br>
                                    </p>
                                </div>
                            </div>
                        </div>
            ...
            <section class="slice slice-lg">
                <div class="container">
                    <div class="mb-5 text-center">
                        <h3 class="mt-4">Ready To Try?</h3>

                        <div class="fluid-paragraph mt-3">
                            <p class="lead lh-180">Start your free trial. Are you ready to try service reign? ! No contract. No credit card</p>
                        </div>
                    </div>

                    <div class="text-center">
                        <form action="http://localhost/Airinei/signup" method="GET">
                            <div class="input-group mb-3">
                                <input type="text" class="form-control" placeholder="Enter your email" name="email">

                                <div class="input-group-append">
                                    <button type="submit" class="btn btn-outline-primary">Get Start Now</button>
                                </div>
                            </div>
                        </form>

                        <div class="small">Do not hesitate to try it out with just a few minutes of setup</div>
                    </div>
                </div>
            </section>
                            ...
                            <div class="card bg-gradient-dark shadow hover-shadow-lg border-0 position-relative zindex-100">
                                <div class="card-body py-5">
                                    <div class="d-flex align-items-start">
                                        ...
                                        <div class="icon-text">
                                            <h3 class="text-white h4">Easy to use</h3>

                                            <p class="text-white mb-0">The intuitive interface and clear and logical layout make it easy to use</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card bg-primary shadow hover-shadow-lg border-0 position-relative zindex-100">
                                <div class="card-body py-5">
                                    <div class="d-flex align-items-start">
                                        ...
                                        <div class="icon-text">
                                            <h5 class="h4 text-white">Free support</h5>

                                            <p class="mb-0 text-white">We give you the best support throughout the use of our service.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="row align-items-center justify-content-md-between py-4 mt-4 delimiter-top">
                ...
                <div class="col-md-6">
                    <div class="text-sm font-weight-bold text-center text-md-right">
                        <a href="../../../privacy.php" class="mr-3 text-white">Privacy Policy</a>

                        <a href="../../../terms.php" class="mr-3 text-white">Terms of Services</a>
                        <a href="mailto:contact@grandsocial.biz" class="mr-3 text-white">contact@grandsocial.org</a>
                    </div>
...
<script src="https://grandsocial.org/pure/set/Tool_files/Tool_files/core.js"></script>
<script src="https://grandsocial.org/pure/set/Tool_files/Tool_files/pure.js"></script>
